...
public static function validarFoto($nombre){
  if(isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
    ...
    if(empty($errors) == true){
      ...
      $path = "./empleados/fotos/".$nombre . "." .$hora.".".$file_ext;
        move_uploaded_file($file_tmp, $path); //MUEVE EL ARCHIVO Y LO RENOMBRA 
        //echo "El archivo ".$file_name." ha sido cargado correctamente.";        
        return "./empleados/fotos/".$nombre . "." .$hora.".".$file_ext; //VA A LA BASE DE DATOS 
    } else echo $errors;
